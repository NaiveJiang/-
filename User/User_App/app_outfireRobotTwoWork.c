	...
	if(outfireRobotState.fireArray[EIGHTH_FIRE] == 1){
		switch(outfireRobotState.workStep){
			...
			case 15:{
				outfireRobotState.moveWays = OTHER;
				calibrationGostraight(RIGHT);
				if(SRF_04_Data1.getDistance <43 && SRF_04_Data2.getDistance <43){
					outfireRobotState.moveWays = STOP;
					outfireRobotState.workStep++;
				}break;
			}
			...
			case 17:{
				...
				outfireRobotState.moveWays = OTHER;
				if(calibrationFinish == CALIBRATION_FINISHED && SRF_04_Data1.getDistance <25 && SRF_04_Data2.getDistance <25){
					outfireRobotState.moveWays = STOP;
					outfireRobotState.workStep++;
				}break;
			}
	...
	if(outfireRobotState.fireArray[SENVENTH_FIRE] == 1){
		switch(outfireRobotState.workStep){
			...
			case 2:{
				calibrationFinish = app_findFire();
				outfireRobotState.moveWays = OTHER;
				if(calibrationFinish == CALIBRATION_FINISHED && SRF_04_Data1.getDistance <22 && SRF_04_Data2.getDistance <22){
					outfireRobotState.moveWays = STOP;
					outfireRobotState.workStep++;
				}break;
			}
			...
			case 7:{
				calibrationGostraight(RIGHT);
				if(SRF_04_Data1.getDistance <14 && SRF_04_Data2.getDistance <14){
					outfireRobotState.workStep++;
				}
				break;
			}
			...
			case 12:{
				calibrationGostraight(RIGHT);
				if(SRF_04_Data1.getDistance <= 65 && SRF_04_Data2.getDistance <= 65 && SRF_04_Data1.getDistance > 16 && SRF_04_Data2.getDistance > 16){
					outfireRobotState.moveWays = GO_STRAIGHT;
				}else if(SRF_04_Data1.getDistance <= 16 && SRF_04_Data2.getDistance <= 16){
					outfireRobotState.moveWays = STOP;
					outfireRobotState.workStep++;
		...
		switch(outfireRobotState.workStep){
			...
			case 2:{
				calibrationGostraight(RIGHT);
				if(SRF_04_Data1.getDistance <12 && SRF_04_Data2.getDistance <12){
					outfireRobotState.moveWays = STOP;
					outfireRobotState.workStep++;
				}break;
			}
